...
const News = (props)=>{
  ...
  /*  const handleNext = async () => {
        ...
        props.setState({ page: page + 1 });
        updateNews();
    }


    const handlePrev = async () => {
        props.setState({ page: this.state.page - 1 });
        updateNews();
    }*/
    useEffect(() => {
...
<h2 className="text-center">News Buzz - Top {capitalizeFirstLetter(props.category)} Headlines</h2>
</div>
